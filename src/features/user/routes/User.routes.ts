...
// ユーザー一覧取得
router.get("/users", verifyAuthToken, isAdmin, (req, res, next) => {
  userController.findAll(req, res, next);
});

// ユーザー取得
router.get("/users/:id", verifyAuthToken, (req, res, next) => {
...
// ユーザー更新
router.put("/users/:id", verifyAuthToken, (req, res, next) => {
  userController.update(req, res, next);
});

// ユーザー削除
router.delete("/users/:id", verifyAuthToken, isAdmin, (req, res, next) => {
